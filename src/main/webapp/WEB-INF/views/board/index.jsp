	...
	<section id="hero">
		<div class="hero-container">
			<a href="index.html" class="hero-logo" data-aos="zoom-in"><img
				src="" alt=""></a>
			<h1 data-aos="zoom-in">Welcome to Nakseong University community.</h1>
			<h2 data-aos="fade-up"> Nakseong University.
			 </h2>
			<a data-aos="fade-up" data-aos-delay="200" href="boardMoves.me"
