...
<body>
	...
	<main class="app-content" >
		...
		<div class="tile mb-4" style="height:500px ">
			<div class="page-header">
				...
				<h2 class="bs-component" style="text-align: center; margin-top: 5%"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> 졸업 기준을 모두 충족하여야 졸업이 가능합니다.  </h2>
			</div>
		</div>
	</main>
</body>
