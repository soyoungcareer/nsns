			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						role="button" data-bs-toggle="dropdown" aria-expanded="false">교수용</a>
		...
		<c:forEach items="${ listt }" var="l">
			<table class="table table-hover table-bordered" id="sampleTable">
				...
				<tbody>
					...
					<tr
						onclick="location.href='lecMoves.me?no=${l.subCode}'">
						<td width="20%">${l.subYear }</td>
						<td width="20%">${ l.subTtile }</td>
						<td width="30%">${ l.subCridit }</td>
